...
package io.github.lxgaming.direct.common.util.text.adapter;
...
public class LocaleAdapter {
    ...
    public static void disconnect(Source source, Locale locale, Object... arguments) {
        source.disconnect(LocaleManager.serialize(locale, arguments));
    }
